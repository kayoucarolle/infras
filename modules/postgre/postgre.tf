...
resource "aws_db_subnet_group" "postgres" {
  ...
  name = format("%s-%s-%s-postgres-subnet", var.common_tags["AssetID"], var.common_tags["Environment"], var.common_tags["Project"])
  subnet_ids = ["subnet-0bfc4191694d95251", "subnet-0fca1bb79c5202937"
  ]
}
